...
**2. Every extracted value carries its receipt.** GLiNER2 reports _character positions_, not
...
**3. Links are real, not strings.** `Event.people` is not `["Tom", "Mum"]`. It holds _references_
...
[
    {
        "result": [
            ...
            {
                "attendees": ["Tom", "Mei's parents"],
                "location": "Victoria Park",
                "name": "Mei's birthday picnic"
            },
            {
                "attendees": ["Anna"],
                "location": "Café Lumen on Bridge Street",
                "name": "breakfast"
            },
...
### 5. Confirm the model reads _your_ input
